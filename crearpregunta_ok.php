	...
	<?php
			...
			if(empty($_POST["pregunta"]) || !isset($_POST["respuestaok"]) || empty($_POST["categoria"])){
				...
				if(empty($_POST["respuesta1"]) || empty($_POST["respuesta2"])) {
					...
					if(empty($_POST["respuesta1"]) && empty ($_POST["respuesta2"])){
							if(isset($_POST["respuesta3"]) && isset($_POST["respuesta4"])) {
								echo "Rellena respuestas 1 y 2 antes <br/><a href='crearpregunta.php'>Vuelve a intentarlo</a>";
							}
							else{
						...
						if(empty($_POST["respuesta3"]) && empty($_POST["respuesta4"])) {	
